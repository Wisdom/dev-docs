  ...
  return (
    <div
      ...
      <div
        ...
        <ul className={classnames("menu__list", styles.menuSecond)}>
          {[
            ['Announcements', '/announcements'],
            ].map(([name, href]) => (
            <li className={classnames("menu__list-item", styles.visible)} key={href}>
              <Link aria-current="page" className="menu__link menu__link" tabIndex="0" to={href}>
                <i className="feather icon-zap"/>&nbsp; {name}
              </Link>
            </li>
          ))}
          <br/>
